//
//  EnterRecipeBoxTableViewController.m
//  webExtract
//
...
@interface EnterRecipeBoxTableViewController ()

@end

@implementation EnterRecipeBoxTableViewController
...
{
    EnterRecipeViewController *transferViewController = segue.destinationViewController;
    if([segue.identifier isEqualToString:@"enterRecipe"])
    {
